...
void initStorageManager(void)
{
	if (StorageManagerStatus == false)
	{
		...
		//printf("\n       <--------BY Group 49-------->      \n");
		printf("\n");
		printf("--------* CS525 - Advanced Database Organization *--------");
		printf("\n");
		printf("-----------* Assignment - 2 - Buffer Manager *------------");
		printf("\n");
		printf("---------------* Implemented By Group - 49 *--------------");
		printf("\n");
		printf("- Sarthak Raghuvanshi (A20543280)");
		printf("\n");
		printf("- Amarthya Parvatha Reddy (A20550000)");
		printf("\n");
		printf("- Neel Patel (A20524638)");
		printf("\n");
	}
}
